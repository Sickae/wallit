...
create table record (id  serial, amount float8, currency varchar(255), transaction_date_utc timestamp, creation_date_utc timestamp, modification_date_utc timestamp, record_category_id int4, account_id int4, primary key (id));
